...
minimalmodbus._print_out('\addr0x01: '                        + str(instrument.read_register(0x0001)))
minimalmodbus._print_out('\addr0x02: '                        + str(instrument.read_register(0x0002)))
